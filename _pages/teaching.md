...
| :---- | :---- | :----------------- | :---- | :---- |
|  21/03 |  all  |  David Sariel  |  **Quick round where everyone says a few words about themselves**<br><br>**Administrative issues**<br>- Explanations on Maman 11/12, Maman 13/14<br>- Project management boards<br>- Code review (Gerrit)<br>- CI (Jenkins) cycles and their role in the course assignments<br>- Explanation of this document (cross-references and which parts to fill in)<br>- Gerrit HOWTO<br>- Peer reviews<br><br>**Demos**<br>**xv6 Demo**<br>**VSSIM and SSD Simulation**<br>- eVSSIM architecture<br>- VSSIM article<br>- How SSDs work<br>- Why garbage collection (GC) is required<br>- Differences between eVSSIM and a real SSD<br>- Use cases for eVSSIM<br>- Overview of different SSD simulation approaches<br>- eVSSIM user manual (cloning and deployment scripts)<br><br>**Bottom line**<br>During the next two weeks, read the materials covered today and assign yourself to one of the tracks (**eVSSIM**, **xv6**, or **Swift**) in Table #2.  | Materials used during this meeting are marked with italics in the \<table 1, column 3\> (the column called additional resources)  |
| 28/03  |  eVSSIM  |  David Sariel  | eVSSIM epics. xv6 epics.  swift epics. Demo: swift Demo: evssim (partial) [NVME hands-on Lab](https://drive.google.com/file/d/0BxXKX8L4jdxTNzRLbVFWSzBwVWc/view?usp=sharing&resourcekey=0-apFWsUQejoBm5RlhcmUbCg)  [NVM express tutorial](https://www.flashmemorysummit.com/English/Collaterals/Proceedings/2013/20130812_PreConfD_Marks.pdf) [Spec v1.3](https://nvmexpress.org/wp-content/uploads/NVM_Express_Revision_1.3.pdf) [SSD performance](https://www.snia.org/sites/default/files/SNIASSSI.SSDPerformance-APrimer2013.pdf)  | TODO: ./docker-run-qemu-enter-guest.sh \-\> fio  |
| 25/04  |  swift  |  David Sariel  |  [Ansible](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html/getting_started_with_playbooks/index)  |  |
|  |  swift  |  David Sariel  |  Implementing Cloud Storage with OpenStack Swift - Chapter 1 - Cloud storage |  |
| 09/05  |  swift  |  David Sariel  | Implementing Cloud Storage with OpenStack Swift - Chapter 2 - Swift architecture  |  |
|  |  swift  |  David Sariel  | Implementing Cloud Storage with OpenStack Swift - Chapter 3 - Installing OpenStack Swift |  |
|  |  swift   |  David Sariel  | Implementing Cloud Storage with OpenStack Swift - Chapter 4 - Using Swift  |  |
|  |  eVSSIM xv6  |  David Sariel  | Linux kernel (based on R. Loves’ book): VFS <br> |  |
| 23/05  |  eVSSIM  | Alon Atia| [FTL](https://docs.google.com/presentation/d/1my5_bbWgFhnnlloTa5Pxkai4OSxgarVBsQhbhT6j2uI/edit?usp=sharing) |  |
|  |  eVSSIM  | Adam Zats | [exofs architecture](https://docs.google.com/presentation/d/1YUrBsL8GRwxbBPeSmUCVjxNU2_5Gaep4/edit?usp=sharing&ouid=114210043453285298284&rtpof=true&sd=true) |  |
|  |  xv6  | Michael Kalyna| [container images](https://docs.google.com/presentation/d/1hrMXuFsIkfQDgCxA2O4ZCVTSRhQZNtnsPEndLp9HQAI/edit?usp=sharing) |  |
|  | all | David Sariel | Linux kernel (based on R. Loves’ book): [Interrupts and Interrupt handlers](https://docs.google.com/presentation/d/1XO-YfB2qImLTjXIruGpXVJXeDrkmOgQ_/edit?usp=sharing&ouid=114210043453285298284&rtpof=true&sd=true) |  |
|  | all | David Sariel | Linux kernel (based on R. Loves’ book): [Bottom Halves and Defering Work](https://docs.google.com/presentation/d/1ow_OR9B8cCFIzLCk9ozjRBIM6C32_SIN/edit?usp=sharing&ouid=114210043453285298284&rtpof=true&sd=true) |  |
|  | all | David Sariel | Linux kernel (based on R. Loves’ book): [Block I/O layer](https://docs.google.com/presentation/d/1sgRUyOfvxcV24kkv7FOdFyna9TTeVB_X/edit?usp=sharing&ouid=114210043453285298284&rtpof=true&sd=true) |  |
